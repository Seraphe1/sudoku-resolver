  ...
  return (
    ...
    <div className='App'>
      ...
      <main className='App-main'>
        ...
        <div className='App-main-actions mini'>(Or <button type="button" tabIndex={sudokuArray.length * sudokuArray.length + 4} className="btn-tertiary" onClick={() => autoFill()}>autofill with example</button>)</div>
        ...
        <div className="App-main-actions">
          ...
          <button className="btn-secondary"
                  onClick={() => resetSudoku()}
                  tabIndex={sudokuArray.length * sudokuArray.length + 3}
                  type="button">Reset grid</button>
        </div>
